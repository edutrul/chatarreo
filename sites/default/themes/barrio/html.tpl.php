...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <!--[if (gte IE 6)&(lte IE 9)]>
    <script type="text/javascript" src="<?php print $directory; ?>/js/libraries/selectivizr-1.0.2/jquery-extended-selectors.js"></script>
    <script type="text/javascript" src="<?php print $directory; ?>/js/libraries/selectivizr-1.0.2/selectivizr-min.js"></script>
    <link href="<?php print $directory; ?>/css/style-bypass-cache.css" rel="stylesheet" type="text/css" />
  <![endif]-->
